...
print('Threshold: %.4f FPR: %.4f Detection rate: %.4f' % (thresholds[idx], 1e-3, tpr[idx]))
...
print('Threshold: %.4f FPR: %.4f Detection rate: %.4f' % (thresholds[idx],np.power(10, fpr[idx]), tpr[idx]))
